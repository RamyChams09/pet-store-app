...
import { ButtonProps, FlexProps, IconProps, TextFieldProps, TextProps } from "@aws-amplify/ui-react";
...
export declare type FooterOverridesProps = {
    ...
    "\u00A9 2023 Pet Store App All rights reserved."?: PrimitiveOverrideProps<TextProps>;
} & EscapeHatchProps;
